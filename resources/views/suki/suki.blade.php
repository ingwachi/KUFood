    ...
    <div style="font-family: 'Kanit', sans-serif; margin-top: 3%">
        ...
        <div class="row">
            <div class="col-9">
                <div class="row">
                    <div class="col">
                        <img src="/img/homepage/content3.png" alt="" style="width: 90%; margin-top: 2%; margin-left: 15%">
                    </div>
                ...
                <div style="margin-left: 7%; margin-top: 2%">
                    <div class="row">
                        <div class="col">
                            <img src="/img/content3/2.jpg" alt="" style="width: 450px; height: 300px">
                            <div style="text-align: center; margin-top: 2%">สุกี้ทะเล</div>
                        </div>
                        <div class="col">
                            <img src="/img/content3/3.jpg" alt="" style="width: 450px; height: 300px">
                            <div style="text-align: center; margin-top: 2%">สุกี้หมู</div>
                        </div>
                    </div>
                </div>
                <div style="margin-left: 7%; margin-top: 5%; margin-bottom: 10%">
                    ...
                    @foreach($menus as $menu)
                        @if($menu->type == 'm')
                            <div class="row" style="font-size: 20px; color: #5a6268">
                                ...
                                <div class="col-3">
                                    <div>{{ $menu->price }} บาท <a href="{{ route('content3.edit', ['content3' => $menu->id]) }}" style="font-size: 15px">แก้ไข</a></div>
                                </div>
                            </div>
                        @endif
                    @endforeach
                    ...
                    @foreach($menus as $menu)
                        ...
                        @endif
                    @endforeach
                    <a href="{{ route('content3.create') }}" class="btn btn-info" style="margin-left: 40%; margin-top: 3%">เพิ่มรายการอาหาร</a>
                </div>
            </div>
            <div class="col-3">
                <div>
