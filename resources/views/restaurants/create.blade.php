...
@section('content')
    <div style="margin-left: 7%; font-family: 'Kanit', sans-serif; margin-top: 5%">
        <div style="font-size: 30px; margin-bottom: 3%">เพิ่มรายการอาหารของร้าน{{ $restaurant->name }}</div>
        <form method="POST" action="{{ route('restaurant.menu.store', ['restaurant' => $restaurant->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col">
